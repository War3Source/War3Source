...
public OnWar3EventPostHurt(victim,attacker,dmgamount)
{
	...
	{	
		...
		if(War3_GetRace(victim)==thisRaceID && skilllevel>0 W3Chance(RewindChance[skilllevel]) && !W3HasImmunity(attacker,Immunity_Skills)&&!Hexed(victim)) //chance roll, and attacker isnt immune to skills
		{
		...
		{
			if(War3_Chance(TimeLockChance[skilllevel])&& !W3HasImmunity(victim,Immunity_Skills) && !bIsStunned[victim]&&!Hexed(attacker))
			{
